...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Declaration.dt_created'
        db.add_column(u'doctors_declaration', 'dt_created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 1, 15, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Declaration.dt_created'
        db.delete_column(u'doctors_declaration', 'dt_created')


    models = {
        u'doctors.declaration': {
            'Meta': {'object_name': 'Declaration'},
            'date_created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 15, 0, 0)'}),
            'doctor': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['doctors.Doctor']"}),
            'dt_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 15, 0, 0)'}),
        ...
        u'doctors.declarationlink': {
            ...
            'expires': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 16, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'b4927ec6'", 'unique': 'True', 'max_length': '64'})
        },
        u'doctors.doctor': {
